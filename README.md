...
Итого **108 unit-тестов** (9+7+7+5+10+8+7+8+6+19+22) + изолированный валидатор. В Проектах 5, 10 и 11 — интеграционные тесты полных игровых/рабочих сценариев через настоящий Dispatcher с перехватом исходящих вызовов Bot API. В каждом README — раздел «Технические особенности» с описанием выявленных ограничений и решений, а также «Планы развития».
