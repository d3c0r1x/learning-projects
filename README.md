...
Итого **130 unit-тестов** (12+9+9+7+12+9+8+9+7+19+29) + изолированный валидатор. В Проектах 5, 10 и 11 — интеграционные тесты полных игровых/рабочих сценариев через настоящий Dispatcher с перехватом исходящих вызовов Bot API. В каждом README — раздел «Технические особенности» с описанием выявленных ограничений и решений, а также «Планы развития».
